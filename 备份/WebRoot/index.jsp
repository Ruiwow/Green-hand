...
.sort{ -webkit-filter: grayscale(100%); /* Chrome, Safari, Opera */
	...
	<body>
		...
		<h3 >今日推荐</h3>
		<!-- 轮播图 -->
		<div id="myCarousel" style="background-color:#F6F7FD; margin-top: 18px;" class="carousel slide" data-ride="carousel" data-interval="3000">
			<!-- 轮播（Carousel）指标 -->
		...
		<div   >
			...
			<h3 >大家推荐  
				<span  class="time" style="  color: rgba(32,203,175,1); margin-top: 5px; font-weight: normal; float: right; margin-right: 25px; font-size:15px;">时间
					<img  class="sort-time" style="   height: 13px; margin-top: -2px; " src="img/166.png" />
				</span>
				<span class="hot" style=" margin-top: 5px; font-size: 15px; font-weight: normal; float: right; margin-right: 20px;" onclick="window.location.href = 'OrderByLike.jsp'">热度 
		...
		<div class="footer">
			...
			<button onclick="window.location.href = '3.jsp'" class="tuijian">
				<span class="badge"style="border-radius: 2.85714rem; line-height:4.2rem;  width:14.28571rem; height:4.85714rem; background-color: rgba(32,203,175,1);font-size: 2.28571rem;">
					我要推荐</span></button>
		</div>
		</div>

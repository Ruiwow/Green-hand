	...
	<body>
		...
		<div class="form-group" style="margin-top: 35px;">
			<div class="panel panel-default"  style="border:1px solid rgba(206,232,255,1)!important;position:relative;overflow:hidden" >
  				<input class="hidden-input"  style="height:100%;width: 95%;" type="file" accept="image/*"   name="photo" onchange="changepic(this)" required="required" />
  				<img  id="show" class="img-responsive" style=" display: flex; margin: auto;" src="img/172.png" />
  		
			</div>
		</div>
		
		<div class="footer" style="margin: 40px;">
			<button type="submit" onclick="" class="fabu"><span class="badge" style="box-shadow: 0px 6px 10px 0px rgba(67,133,255,0.5); border-radius: 2.85714rem; line-height:5.5rem;  width:25.71428rem; height:6.42857rem; background-color: rgba(67,133,255,1);font-size:2.71428rem;">发布推荐</span></button>
		</div>
		</form>

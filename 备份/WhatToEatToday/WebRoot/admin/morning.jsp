...
<div>
  ...
  <div class="left">
    ...
    <div class="ab-1">
    <a class="head-1" href="admin/morning.jsp" style="color:rgba(32,203,175,1); text-decoration:none" id="a2" onclick="b()">上午推荐</a></div>
    <div class="ab-1">
  ...
  <div class="font-style-2">
			...
			<input type="hidden" value="早" name="time"/>
